...
interface ProductSpec {
  ...
  matches?: boolean;
  expected?: string;
  isRequested?: boolean; // true = fait partie des critères demandés, false/undefined = info complémentaire
}
...
interface ProductDetailProps {
  product: {
    ...
    name: string;
    images: string[];
    media?: MediaItem[]; // New: supports images and videos
    description: string;
    descriptionHtml?: string; // New: rich HTML description
    specs: ProductSpec[];
          ...
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <div>
              ...
              <div className="grid gap-2 sm:grid-cols-2">
                {product.specs
                  .filter(spec => spec.value || spec.matches === undefined) // Hide if no value AND not explicitly requested
                  .map((spec, idx) => {
                    const isRequested = spec.isRequested !== false; // Default to requested if not specified
